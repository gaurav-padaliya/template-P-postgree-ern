export const enum CronExpression {
  ...
  EVERY_SUNDAY_AT_MIDNIGHT = '0 0 * * 0', // Every Sunday at midnight
  EVERY_MONDAY_AT_MIDNIGHT = '0 0 * * 1', // Every Monday at midnight
  EVERY_TUESDAY_AT_MIDNIGHT = '0 0 * * 2', // Every Tuesday at midnight
  EVERY_WEDNESDAY_AT_MIDNIGHT = '0 0 * * 3', // Every Wednesday at midnight
  EVERY_THURSDAY_AT_MIDNIGHT = '0 0 * * 4', // Every Thursday at midnight
  EVERY_FRIDAY_AT_MIDNIGHT = '0 0 * * 5', // Every Friday at midnight
  EVERY_SATURDAY_AT_MIDNIGHT = '0 0 * * 6', // Every Saturday at midnight
  EVERY_WEEKDAY_AT_MIDNIGHT = '0 0 * * 1-5', // Every weekday (Monday to Friday) at midnight
  EVERY_MONTH_AT_MIDNIGHT = '0 0 1 * *', // First day of every month at midnight
  EVERY_YEAR_AT_MIDNIGHT = '0 0 1 1 *', // First day of every year at midnight
}
